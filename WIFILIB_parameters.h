/**
Atomix project, WIFILIB_parameters.h, TODO: insert summary here
Copyright (c) 2015 Stanford University
Released under the Apache License v2.0. See the LICENSE file for details.
Author(s): Manu Bansal
*/

#ifndef WIFILIB_PARAMETERS_
#define WIFILIB_PARAMETERS_
...
//                  struct S_WIFILIB_TxRxPktState *pktState);
    
    Uint32 currPktPortion;
    Uint32 currSymbolIdx; //index of the current OFDM symbol we are processing


} WIFILIB_TxRxPktState;


//typedef WIFILIB_TxRxPktState *PWIFILIB_TxRxPktState;
...
//extern WIFILIB_TxRxPktState txRxPktState;
...
//void wifi_setPktState(WIFILIB_TxRxPktState *retState, Uint8 dataRate, Uint32 NumInfoOctets, Uint32 includingTail);
void WIFILIB_setPktState(WIFILIB_TxRxPktState *retState, Uint8 dataRate, Uint32 NumInfoOctets);

//void wifi_setSigPktState(WIFILIB_TxRxPktState *sigPktState);
