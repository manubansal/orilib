/**
Atomix project, ORILIB_ViterbiDecoderVCP_WaitForCompletion_i.h, TODO: insert summary here
Copyright (c) 2015 Stanford University
Released under the Apache License v2.0. See the LICENSE file for details.
Author(s): Manu Bansal
*/

#ifndef ORILIB_VITERBIDECODERVCP_WAITFORCOMPLETION_I_H_
#define ORILIB_VITERBIDECODERVCP_WAITFORCOMPLETION_I_H_
