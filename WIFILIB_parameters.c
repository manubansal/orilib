/**
Atomix project, WIFILIB_parameters.c, TODO: insert summary here
...
//Uint32 NumCodedBits;
//Uint32 NumConstPnts;
//WIFILIB_TxRxPktState txRxPktState;
 ...
 * affected parameters */
//void wifi_setPktState(WIFILIB_TxRxPktState *txRxPktState, Uint8 dataRate, Uint32 numInfoOctets, Uint32 includingTail) {
void WIFILIB_setPktState(WIFILIB_TxRxPktState *txRxPktState, Uint8 dataRate, Uint32 numInfoOctets) {
//	WIFILIB_TxRxPktState *txRxPktState = retState;
...
//	txRxPktState->NumUncodedBits = ceil((txRxPktState->NumInfoBits + (1 - includingTail) * PHY_TAIL_SIZE_BITS),
	...
	txRxPktState->NumPadBits = txRxPktState->NumUncodedBits - txRxPktState->NumInfoBits
									- (1 - includingTail) * PHY_TAIL_SIZE_BITS - PHY_SERVICE_SIZE_BITS;
