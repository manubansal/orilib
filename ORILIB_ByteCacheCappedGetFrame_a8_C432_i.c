/**
Atomix project, ORILIB_ByteCacheCappedGetFrame_a8_C432_i.c, TODO: insert summary here
...
void ORILIB_ByteCacheCappedGetFrame_a8_C432_i (
	IN  ORILIB_t_ByteCacheCapped432	* inpCache,
	...
	Uint32 cacheCapacityInBytes = 432;
	...
	Uint32 inpCacheTotalConsumedInBytes = inpCache->totalConsumedInBytes;
	Uint32 outCacheTotalConsumedInBytes;

	Uint32 totalConsumeCapInBytes = inpCache->totalConsumeCapInBytes;

	ORILIB_ByteCacheCappedGetFrame_a8_algo (
		inpCacheBytes,
		outBufBytes,
		outCacheBytes,
		...
		totalConsumeCapInBytes,
		inpCacheTotalConsumedInBytes,
		&outCacheTotalConsumedInBytes
	);


	outCache->validLenInBytes = outCacheValidLenInBytes;
	outCache->totalConsumeCapInBytes = totalConsumeCapInBytes;
	outCache->totalConsumedInBytes = outCacheTotalConsumedInBytes;
...
//out cache contains:                              [.....................]
//out cache result  : [.....................]
void ORILIB_ByteCacheCappedGetFrame_a8_C432_i_conf (
	CF  ORILIB_t_ByteCacheGetFrameConf * conf,
